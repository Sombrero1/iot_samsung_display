...
extern touchgfx::GeneratedFont& getFont_AGENCYR_TTF_28_4bpp();

const touchgfx::Font* touchgfx_fonts[] =
{
    &(getFont_RobotoCondensed_Regular_24_4bpp()),
    &(getFont_RobotoCondensed_Regular_22_4bpp()),
    &(getFont_AGENCYR_TTF_28_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_RobotoCondensed_Regular_24_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_RobotoCondensed_Regular_22_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_AGENCYR_TTF_28_4bpp());
        break;
    }
}
}  // namespace TypedTextDatabase
